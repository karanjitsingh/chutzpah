...
namespace Chutzpah.FrameworkDefinitions.PhantomJS
{
    ...
    public class JasmineDefinition : BaseFrameworkDefinition
    {
        ...
        public JasmineDefinition(IEnumerable<IJasmineReferencedFileProcessor> fileProcessors)
        {
            ...
            testRunner["1"] = @"ChutzpahJSRunners\PhantomJS\jasmineRunnerV1.js";
            testRunner["2"] = @"ChutzpahJSRunners\PhantomJS\jasmineRunnerV2.js";
        }
        ...
        public override JavaScriptEngine JavaScriptEngine {
            get
            {
                return JavaScriptEngine.PhantomJS;
            }
