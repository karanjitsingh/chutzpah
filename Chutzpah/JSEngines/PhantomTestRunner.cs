...
namespace Chutzpah
{
    public class PhantomTestRunner : ITestRunner
    {
        ...
        {
            var runner = ChutzpahContainer.Current.GetInstance<PhantomTestRunner>();
            if (debugEnabled)
            {
        ...
        public PhantomTestRunner(IProcessHelper process,
